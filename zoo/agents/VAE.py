...
class VAE(AgentInterface):
    ...
    def __init__(
        self, name, encoder, decoder, n_steps_beta_reset, beta, lr, beta_starting_step, beta_rate, queue_capacity,
        action_selection, tensorboard_dir, checkpoint_dir, n_actions, n_states, image_shape, steps_done=0,
        verbose=False, **_
    ):
        """
        Constructor
    ...
    def learn(self, config):
        ...
        _, _, _, _, next_obs = self.buffer.sample(config.task.batch_size)
